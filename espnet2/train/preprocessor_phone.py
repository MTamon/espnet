...
class ASRPPreprocessor(AbsPreprocessor):
    def __init__(
        ...
        if token_type == "aux_phone" or token_type == "char_phone":
            ...
            phone_token_list, char_token_list = token_list.split(",")
            ...
            self.char_token_id_converter = TokenIDConverter(
                token_list=char_token_list,
    ...
    def _text_process(
        ...
        if self.text_name in data and self.tokenizer is not None:
            ...
            tokens = self.tokenizer.char_text2tokens(text)
        ...
        if self.phoneme_name in data and self.tokenizer is not None:
